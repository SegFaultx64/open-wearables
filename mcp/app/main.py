...
from app.tools.tracks import tracks_router
...
mcp = FastMCP(
    ...
    - get_workout_track: Get the GPS track for a workout (FIT/GPX-derived). format='geojson' (default) or 'raw'.
    - get_workout_streams: Get per-sample sensor streams (HR, power, cadence, speed, temperature) for a workout.
